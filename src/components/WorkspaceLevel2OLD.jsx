                ...
                return (
                  <motion.div
                    ...
                    onDragEnd={(event, info) => {
                      ...
                      const newX = info.point.x - workspace.left - 50 // Subtract half component width
                      const newY = info.point.y - workspace.top - 50 // Subtract half component height

                      setComponentPositions(prev => ({
                        ...prev,
                        [component.id]: {
                          x: Math.max(0, Math.min(newX, workspace.width - 100)),
                          y: Math.max(0, Math.min(newY, workspace.height - 100))
                        }
                      }))
                    }}
                    onClick={(e) => {
