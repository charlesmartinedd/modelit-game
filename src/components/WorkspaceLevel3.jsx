...
const WorkspaceLevel3 = ({ components, arrows, onRemoveComponent, onAddArrow, onRemoveArrow }) => {
  ...
  return (
    <div className="workspace-level3" ref={workspaceRef} onClick={handleWorkspaceClick}>
      ...
      <div className="workspace-footer">
        <div className="control-hint">
          ...
          <span className="hint-item">🟢 <strong>Green</strong> = Increases (+)</span>
          <span className="hint-item">🔴 <strong>Red</strong> = Decreases (-)</span>
